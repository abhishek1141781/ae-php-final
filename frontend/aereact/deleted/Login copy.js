...
import {
  ...
  manualLoginUser,
} from "../src/servicesArea/user_service";
import { doLogin } from "../src/auth/authIndex";
  ...
  const handleFormSubmit = (event) => {
    ...
    manualLoginUser(loginDetail)
      .then((respData) => {
        ...
        doLogin(respData, () => {
          console.log(
            "full backend server response is saved to localStorage: ",
            respData
          );
          ...
          console.log(
            "from UserDashboard: navigating to this page: /user/profile-info/" +
              respData.user_id
          );
                ...
                <CardBody>
                  <Form onSubmit={handleFormSubmit}>
                    ...
                    <Container className="text-center">
                      <Button color="dark" outline className="me-2">
                        Login
                      </Button>

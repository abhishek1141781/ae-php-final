...
const UserDashboard = () => {
  ...
  function loadPostData() {
    loadPostsUserWise(getCurrentUserDetail().user_id).then(data => {
      console.log("data from load post user wise from loadPostData: ", data)
      setPosts([...data.content])
      // console.log(data.content)
      console.log("check if posts have been set: ",posts)
    }).catch(error => {
      console.log(error)

...
export const Post = ({ post = { id: -1, title: "default event tilte", content: "default event content" }, deletePost }) => {
    ...
    return (
        <Card className='border-0 shadow-sm mt-3'>
            <CardBody>
                <h4 className=''>{"ID: " + post.event_id}</h4>
                ...
                <div>
                    <Link to={"/posts/" + post?.event_id} className='btn btn-secondary'>View Details</Link>

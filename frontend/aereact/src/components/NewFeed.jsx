...
export const NewFeed = () => {
    ...
    const changePage = (pageNumber = 0, pageSize = 5) => {
        ...
        loadAllPosts(pageNumber, pageSize).then(data => {
            ...
            console.log("response.data from loadAllPosts: backend: ",data)
            // console.log("response.data: loadAllPosts complete data from backend: ",data.data)
                    ...
                    >
                        {
                            postContent.content.map((post) => (
                                // console.log("postContent.content.map((post) => (: ",post);
